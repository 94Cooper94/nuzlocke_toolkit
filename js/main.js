// game titles to add, store and track encounters and active pokemon
var games = {
	'rby': {
		'id': 'rby',
	...
	'swsh': {
		...
		'locations': [
			...
			{
				"name": "Crown Tundra: Old Graveyard",
				"value": 55
            },
            {
